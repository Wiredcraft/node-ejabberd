...
Ejabberd.prototype.addRosterGroup = function(group, host, name, description, display) {
  var ejabberd = this;
  var errMsg;
...
Ejabberd.prototype.removeRosterGroup = function(group, host) {
  var ejabberd = this;
  var errMsg;
...
Ejabberd.prototype.addRosterMembers = function(usernames, host, group, grouphost) {
  var ejabberd = this;
  var errMsg, promises = [];
  var d = Q.defer();
...
Ejabberd.prototype.removeRosterMembers = function(usernames, host, group, grouphost) {
  var ejabberd = this;
  var errMsg, promises = [];
  var d = Q.defer();
  usernames = _(usernames).isArray() ? usernames : [usernames];
