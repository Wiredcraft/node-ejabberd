...
Ejabberd.prototype.changePasswords = function(username, hosts, newPass) {
  ...
  var ejabberd = this;
  var errMsg, steps = [];
  var factory = function(ejabberd, username, host, newPass) {
    return function() {
      control.changePassword(ejabberd, username, host, newPass);
    }
  };
  ...
  hosts.forEach(function(host) {
    steps.push(factory(ejabberd, username, host, newPass));
  });

  var promise = steps.unshift().call(this);
