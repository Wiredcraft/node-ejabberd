...
module.exports = {
  ...
  srgUserAdd: function(ejabberd, username, host, group, grouphost) {
    var cmd = ejabberd.sudo ? 'sudo' : ejabberd.ctl;
    var args = ejabberd.sudo ? [ejabberd.ctl, 'srg_user_add', user, host, group, grouphost] : ['srg_user_add', user, host, group, grouphost];
  ...
  srgUserDel: function(ejabberd, username, host, group, grouphost) {
    var cmd = ejabberd.sudo ? 'sudo' : ejabberd.ctl;
    var args = ejabberd.sudo ? [ejabberd.ctl, 'srg_user_del', user, host, group, grouphost] : ['srg_user_del', user, host, group, grouphost];
