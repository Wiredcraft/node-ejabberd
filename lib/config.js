...
module.exports = exports = {
  updateConfig: function(ejabberd) {
    ...
    var data = ejs.render(cfgTempl, ejabberd.db);

    logger.debug('Promise to update ejabberd config file: ', file);
  ...
  updateVhostConfig: function(ejabberd, host, config) {
    ...
    logger.debug('Promise to write file: ', file);
  ...
  removeVhostConfig: function(ejabberd, host) {
    ...
    logger.debug('Promise to unlink file: ', file);
